        ...
        <Layout>
          ...
          <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-[#3c3c3c] p-8 shadow-lg rounded-lg w-full">
              ...
              <form onSubmit={handleSubmit} action="https://formsubmit.co/contact@vencentdomingo.com" method="POST">
            ...
            <div className="w-full">
              ...
              <div className="h-80 w-full rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Makati+City,+Metro+Manila,+Philippines&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
